...
![Resultado de pesquisa do Google Search com um seta vermelha na quinta posição](/figures/seo_cor_2022-09-28.webp "Box Shadow | Sabrina S. Santos 5ª posição")
...
```html
<title>Magenta "#e0138c" na aplicação de SEO | Sabrina S. Santos</title>
```
...
<meta
  name="title"
  property="og:title"
  content='Magenta "#e0138c" na aplicação de SEO | Sabrina S. Santos'
/>
<meta
  name="description"
...
<meta
  ...
  property="og:image"
  itemprop="image"
  content="https://SabrinaSS.com/ogimage/seo-e0138c.jpg"
/>
```
...
![Resultado de pesquisa no Google Search para o termo "#e0138c", magenta vibrante, na segunda posição e imagens são todos uma referência a Sabrina S. Santos](/figures/seo_cor_2022-10-10.webp)
...
![Resultado de pesquisa no Google Search para o termo "#e0138c", magenta vibrante, onde a primeira, segunda, terceira posições e imagens são todos uma referência a Sabrina S. Santos](/figures/seo_cor_2022-10-17.webp)

A proposta era simples, competir com as página de listagem de cores e foi superada com uma certa margem

Essa página já está em primeiro lugar para "Sabrina S. Santos" e "Johny William de Oliveira Alves", qual termo devo buscar na próxima?
